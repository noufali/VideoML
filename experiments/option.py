...
class Options():
    def __init__(self):
        ...
        train_arg.add_argument("--style-folder", type=str, default="styles/",
        ...
        optim_arg.add_argument("--style-image", type=str, default="styles/3d1.png",
        ...
        eval_arg.add_argument("--content-image", type=str, required=True,
                                help="path to content image you want to stylize")
        eval_arg.add_argument("--style-image", type=str, default="styles/3d1.png",
                                help="path to style-image")
        eval_arg.add_argument("--content-size", type=int, default=512,
                                help="factor for scaling down the content image")
        eval_arg.add_argument("--style-size", type=int, default=512,
                                help="size of style-image, default is the original size of style image")
        eval_arg.add_argument("--style-folder", type=str, default="styles/",
                                help="path to style-folder")
        ...
        demo_arg.add_argument("--style-folder", type=str, default="styles/",
                                help="path to style-folder")
